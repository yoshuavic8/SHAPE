...
export default function HeartQuestionnairePage() {
  ...
  const heartSection = questionnaireSections.find((section) => section.id === "heart")
  const questions = heartSection?.questions || []
  ...
  const handlePrevious = () => {
    if (currentQuestionIndex > 0) {
      ...
      router.push("/questionnaire/spiritual")
    }
  }
            ...
            <div>
              ...
              {currentQuestion.type === "multiple" && currentQuestion.options && !currentQuestion.text.includes("Urutkan") && (
                <QuestionnaireMultiple
                  ...
                  value={answers[currentQuestion.id] || ""}
                  onChange={handleAnswerChange}
                  multiSelect={currentQuestion.text.includes("Pilih")}
                />
              )}
